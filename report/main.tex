...
% Currency helper for plain numbers
\newcommand{\money}[1]{\$\num{#1}}

% --- Load generated inputs *before* using the macros --------------------------
\input{report/inputs}

% Metadata (now the macros exist)
\title{Bitcoin Investment Proposal}
\author{Pierre-Alexandre Crouzet / Desk}
\date{\csname reportDate\endcsname}

% Figures live in report/outputs relative to repo root
