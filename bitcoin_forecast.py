...
\newcommand{\spotUSD}{%s}
\newcommand{\probUpOneDay}{%s}
\newcommand{\sigmaOneDay}{%s}
%% One-day
\newcommand{\pOneMed}{%s}
\newcommand{\pOneP10}{%s}
\newcommand{\pOneP90}{%s}
...
\newcommand{\pOneP95}{%s}
%% Seven-day
\newcommand{\pSevenMed}{%s}
\newcommand{\pSevenP10}{%s}
\newcommand{\pSevenP90}{%s}
\newcommand{\pSevenP05}{%s}
\newcommand{\pSevenP95}{%s}
%% Thirty-day
\newcommand{\pThirtyMed}{%s}
\newcommand{\pThirtyP10}{%s}
\newcommand{\pThirtyP90}{%s}
\newcommand{\pThirtyP05}{%s}
\newcommand{\pThirtyP95}{%s}
%% Numeric (no commas) for tables
\newcommand{\pOneMedNum}{%.2f}
\newcommand{\pOneP10Num}{%.2f}
\newcommand{\pOneP90Num}{%.2f}
\newcommand{\pOneP05Num}{%.2f}
\newcommand{\pOneP95Num}{%.2f}
\newcommand{\pSevenMedNum}{%.2f}
\newcommand{\pSevenP10Num}{%.2f}
\newcommand{\pSevenP90Num}{%.2f}
\newcommand{\pSevenP05Num}{%.2f}
\newcommand{\pSevenP95Num}{%.2f}
\newcommand{\pThirtyMedNum}{%.2f}
\newcommand{\pThirtyP10Num}{%.2f}
\newcommand{\pThirtyP90Num}{%.2f}
